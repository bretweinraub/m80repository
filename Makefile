...
#
# m80 was Built for Linux by bweinraub on localhost, Sat Feb  6 01:54:52 UTC 2010
# 
# Edits MAY be lost if this file is regenerated.
#
# The following line(s) is for internal use and should not be changed:
# CLISP (setq COMMAND "newRepository"
# CLISP       ARGS '( "-t" "tagvalue")
# CLISP       VERSION "0.07.33")
#
